...
#os.system('e: && cd \MyFile\VisualStudio\Tobbi_eyes\eyes\x64\Debug && eyes.exe')  # 加&&可执行多条语句
...
serial = serial.Serial('COM2', 9600, timeout=0.5)  # 打开COM并设置波特率为115200，COM1只适用于Windows
